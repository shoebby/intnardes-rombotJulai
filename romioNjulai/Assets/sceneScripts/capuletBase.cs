...
public class capuletBase : MonoBehaviour
{
    ...
    {
        //day 1
        if (gameManager.dayTracker == 1 && gameManager.capuletTracker == 1)
        {
            NPCsDay1_morning.SetActive(true);
        } else if (gameManager.dayTracker == 1 && gameManager.capuletTracker == 2)
        {
        ...
        //day 2
        else if (gameManager.dayTracker == 2 && gameManager.capuletTracker == 2)
        {
            NPCsDay2_morning.SetActive(true);
        } else if (gameManager.dayTracker == 2 && gameManager.capuletTracker == 1)
        {
            NPCsDay2_unAllied.SetActive(true);
        } else if (gameManager.dayTracker == 2 && gameManager.capuletTracker == 3)
        {
        ...
        //day 3
        else if (gameManager.dayTracker == 3 && gameManager.capuletTracker == 3)
        {
            NPCsDay3_morning.SetActive(true);
        } else if (gameManager.dayTracker == 3 && gameManager.capuletTracker == 1)
        {
            NPCsDay3_unAllied.SetActive(true);
        } else if (gameManager.dayTracker == 3 && gameManager.capuletTracker == 4)
        {
            NPCsDay3_evening.SetActive(true);
        }
        //day 4
        else if (gameManager.dayTracker == 4 && gameManager.capuletTracker == 4)
        {
            NPCsDay4_allied.SetActive(true);
        } else if (gameManager.dayTracker == 4 && gameManager.capuletTracker == 1)
        {
